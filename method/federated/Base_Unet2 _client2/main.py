...
def create_keras_model():
    ...
    def Conv_res(x, nb_fileter, kernerl_size, name=None, padding=None, activation=None):
        x = Conv1D(nb_fileter, kernerl_size, activation='relu', padding='same')(x)
        x0 = x
    ...
    encoder1_1 = Conv1D(24, 3, padding='same', name='encoder1_1')(x)  # (input)
    encoder1_1 = Lambda(gelu)(encoder1_1)
    encoder1_1 = BatchNormalization()(encoder1_1,training=True)
    pool1 = MaxPooling1D(2, name='pool1')(encoder1_1)  # 30

    encoder2_1 = Conv1D(48, 3, padding='same', name='encoder2_1')(pool1)  # (pool1)
    encoder2_1 = Lambda(gelu)(encoder2_1)
    encoder2_1 = BatchNormalization()(encoder2_1,training=True)
    ...
    encoder1_2 = Conv1D(24, 3, padding='same', name='encoder1_2')(encoder1_2)  # (encoder1_2)
    encoder1_2 = Lambda(gelu)(encoder1_2)
    encoder1_2 = BatchNormalization()(encoder1_2,training=True)
    # encoder1_2 = squeeze_excite_block(encoder1_2,24)

    encoder3_1 = Conv1D(32, 3, padding='same', name='encoder3_1')(pool2)  # (pool2)
    encoder3_1 = Lambda(gelu)(encoder3_1)
    encoder3_1 = BatchNormalization()(encoder3_1,training=True)
    ...
    encoder2_2 = Conv1D(48, 3, padding='same', name='encoder2_2')(encoder2_2)  # (encoder2_2)
    encoder2_2 = Lambda(gelu)(encoder2_2)
    encoder2_2 = BatchNormalization()(encoder2_2,training=True)

    up1_3 = UpSampling1D(2, name='unpool1_3')(encoder2_2)
    encoder1_3 = concatenate([encoder1_2, encoder1_1, up1_3], name='merge1_3', axis=2)
    encoder1_3 = Conv1D(24, 3, padding='same', name='encoder1_3')(encoder1_3)  # (encoder1_3)
    encoder1_3 = Lambda(gelu)(encoder1_3)
    encoder1_3 = BatchNormalization()(encoder1_3,training=True)

    encoder4_1 = Conv1D(16, 3, padding='same', name='encoder4_1')(pool3)  # (pool3)
    encoder4_1 = Lambda(gelu)(encoder4_1)
    encoder4_1 = BatchNormalization()(encoder4_1,training=True)
    ...
    encoder3_2 = Conv1D(32, 3, padding='same', name='encoder3_2')(encoder3_2)  # (encoder3_2)
    encoder3_2 = Lambda(gelu)(encoder3_2)
    encoder3_2 = BatchNormalization()(encoder3_2,training=True)

    up2_3 = UpSampling1D(2, name='unpool2_3')(encoder3_2)
    encoder2_3 = concatenate([encoder2_2, encoder2_1, up2_3], name='merge2_3', axis=2)
    encoder2_3 = Conv1D(48, 3, padding='same', name='encoder2_3')(encoder2_3)  # (encoder2_3)
    encoder2_3 = Lambda(gelu)(encoder2_3)
    encoder2_3 = BatchNormalization()(encoder2_3,training=True)
    ...
    encoder1_4 = Conv1D(24, 3, padding='same', name='encoder1_4')(encoder1_4)  # (encoder1_4)
    encoder1_4 = Lambda(gelu)(encoder1_4)
    encoder1_4 = BatchNormalization()(encoder1_4,training=True)

    encoder5_1 = Conv1D(8, 3, padding='same', name='encoder5_1')(pool4)  # (pool4)
    encoder5_1 = Lambda(gelu)(encoder5_1)
    encoder5_1 = BatchNormalization()(encoder5_1,training=True)

    up4_2 = UpSampling1D(2, name='unpool4_2')(encoder5_1)
    encoder4_2 = concatenate([up4_2, encoder4_1], name='merge4_2', axis=2)
    encoder4_2 = Conv1D(16, 3, padding='same', name='encoder4_2')(encoder4_2)  # (encoder4_2)
    encoder4_2 = Lambda(gelu)(encoder4_2)
    encoder4_2 = BatchNormalization()(encoder4_2,training=True)

    up3_3 = UpSampling1D(2, name='unpool3_3')(encoder4_2)
    encoder3_3 = concatenate([up3_3, encoder3_1, encoder3_2], name='merge3_3', axis=2)
    encoder3_3 = Conv1D(32, 3, padding='same', name='encoder3_3')(encoder3_3)  # (encoder3_3)
    encoder3_3 = Lambda(gelu)(encoder3_3)
    encoder3_3 = BatchNormalization()(encoder3_3,training=True)
    ...
    encoder2_4 = Conv1D(48, 3, padding='same', name='encoder2_4')(encoder2_4)  # (encoder2_4)
    encoder2_4 = Lambda(gelu)(encoder2_4)
    encoder2_4 = BatchNormalization()(encoder2_4,training=True)
    ...
    encoder1_5 = Conv1D(24, 3, padding='same', name='encoder1_5')(encoder1_5)  # (encoder1_5)
    encoder1_5 = Lambda(gelu)(encoder1_5)
    encoder1_5 = BatchNormalization()(encoder1_5,training=True)
    ...
    output4 = Conv1D(1, 3, activation='sigmoid', padding='same', name='output_4', kernel_initializer='he_normal')(
        encoder1_5)  # 记得取消正则
    ...
    model1 = Model(inputs=input, outputs=output44)
    #model1.summary()
    return model1
'''
...
for i in [NUM_CLIENTS]:
    client_num = i
    path = r'/home/b220/PycharmProjects/zxh/compelete-experiment/divide dataset same as LiJia_client_num=2/dataset'
    print(path)
